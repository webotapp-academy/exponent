...
class StudyMaterialsScreen extends StatefulWidget {
  ...
  const StudyMaterialsScreen({super.key, this.subjectId});
...
class _StudyMaterialsScreenState extends State<StudyMaterialsScreen>
  ...
  int _selectedTab = 0; // 0: Class 12, 1: Class 12 Assamese, 2: NEET
  ...
  void initState() {
    ...
    _startAnimations();
    _coursesFuture = fetchSubjects('class12Preview');
                  ...
                  children: [
                    ...
                    _SegmentTab(
                      ...
                      onTap: () => setState(() {
                        _selectedTab = 1;
                        _coursesFuture =
                            fetchSubjects('class12AssamesePreview');
                      }),
                      color: Colors.purple[700]!,
                    ),
                    _SegmentTab(
                      ...
                      onTap: () => setState(() {
                        _selectedTab = 2;
                        _coursesFuture = fetchSubjects('neetPreview');
                      }),
                      color: Colors.purple[700]!,
                    ),
                  ],
